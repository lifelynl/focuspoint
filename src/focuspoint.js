...
(function (global) {
    ...
    function View (viewElm, x, y, options) {
        ...
        Api.set = function set (x, y) {
            try {
                ...
                return helpers.error(Api.options, e);
            }
        };
        ...
        try {
            ...
            // Options
            Api.options = {};
            Api.options.show_errors = options && typeof options.show_errors !== 'undefined' ? options.show_errors : true;
    ...
    function Edit (containerElm, btnElm, options) {
        ...
        Api.on = function on (eventName, cb) {
            try {
        ...
        /*****************************************************/
        Api.attachBackgroundPosition = function attachBackgroundPosition (elm) {
            try {
                ...
                var onMoveId = Api.on('move', setToElm);
                setToElm(Api.x, Api.y);
        ...
        Api.detachBackgroundPosition = Api.off;
        ...
        try {
            ...
            Api.options = {};
            Api.options.show_errors = options && typeof options.show_errors !== 'undefined' ? options.show_errors : true;
            Api.options.hide_cursor = options && typeof options.hide_cursor !== 'undefined' ? options.hide_cursor : true;
            Api.options.default_x = options && typeof options.default_x !== 'undefined' ? options.default_x : .50;
            Api.options.default_y = options && typeof options.default_y !== 'undefined' ? options.default_y : .50;
            Api.options.classnames = {};
            Api.options.classnames.container_hidecursor = options && options.classnames && typeof options.classnames.container_hidecursor !== 'undefined' ? options.classnames.container_hidecursor : 'lfy-focuspoint-edit-hidecursor';
            ...
            // Default state
            Api.set(Api.options.default_x, Api.options.default_y);
            ...
            btnElm.addEventListener('mousedown', function (event) {
                ...
                Api.set(start_pos.x, start_pos.y);
                _listeners.applyFor('start', [
                    start_pos.x,
                    start_pos.y
                ]);
                if (Api.options.hide_cursor) {
                    containerElm.classList.add(Api.options.classnames.container_hidecursor);
                }

                var move = function (event) {
                    window.requestAnimationFrame(function () {
                        var move_pos = _getPositionByEvent(event);
                        Api.set(move_pos.x, move_pos.y);
                ...
                var up = function (event) {
                    ...
                    containerElm.classList.remove(Api.options.classnames.container_hidecursor);
